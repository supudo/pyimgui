...
def input_text(str label, str value, cimgui.ImGuiInputTextFlags flags=0):
    ...
    # cdef char* inout_text = bytes_text

    # changed = cimgui.InputText(
    #     _bytes(label), inout_text, len(bytes_text), flags,
    #     NULL, NULL
    # )
    ...
    changed = cimgui.InputText(
        _bytes(label), inout_text, sizeof(inout_text), flags, NULL, NULLewq)
